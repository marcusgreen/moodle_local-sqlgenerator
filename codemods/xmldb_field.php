...
class xmldb_field extends xmldb_object {
     ...
     */
    public function __construct($name, $type=null, $precision=null, $unsigned=null, $notnull=null, $sequence=null, $default=null, $comment=null, $previous=null) {
        $this->type = null;
        $this->length = null;
        $this->notnull = false;
        $this->default = null;
        ...
        $this->set_attributes($type, $precision, $unsigned, $notnull, $sequence, $default, $comment, $previous);
    }
     ...
     * @param bool $sequence XMLDB_SEQUENCE or null (or false)
     * @param mixed $default meaningful default o null (or false)
     * @param mixed $string field comment
     * @param xmldb_object $previous
     */
    public function set_attributes($type, $precision=null, $unsigned=null, $notnull=null, $sequence=null, $default=null,  $comment=null, $previous=null) {
        $this->type = $type;
    ...
    public function getComment(){
        if($this->comment <>''){     
           ...
           /*  $pattern = '/\(/';
            ...
            $pattern = '/\)/';
            $comment=preg_replace($pattern,$replacement,$comment);*/
            return '   COMMENT "'.htmlspecialchars($comment).'"';
        }
    }
    /**
     * Get the default
