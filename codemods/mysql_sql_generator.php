...
class mysql_sql_generator extends sql_generator {
    ...
    /** Previously the magic number 60 which truncated many comments */
    const COMMENT_MAX_SIZE = 1024;
    ...
    function getCommentSQL ($xmldb_table) {
        ...
        if ($xmldb_table->getComment()) {
            ...
            $comment .= " COMMENT='" . $this->addslashes(substr($xmldb_table->getComment(), 0, self::COMMENT_MAX_SIZE)) . "'";
        }
